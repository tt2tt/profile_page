export default function PortfolioItem({ image, title, description, lang, websiteLink, githubLink }) {
  return (
    <div className="col-span-12 sm:col-span-8 md:col-span-4 lg:col-span-4 xl:col-span-3">
      <li className="card border border-gray-300 rounded-lg shadow-sm bg-gray-100 mx-auto">
